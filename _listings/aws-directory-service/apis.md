...
created: "2018-08-26"
modified: "2018-08-26"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/directories/master/_listings/aws-directory-service/apis.md
...
- name: AWS Directory Service API - Create Trust
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/directories/master/_listings/aws-directory-service/actioncreatetrust-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/directories/master/_listings/aws-directory-service/actioncreatetrust-get-openapi.md
- name: AWS Directory Service API - Create Trust
  x-api-slug: actioncreatetrust-get
  description: AWS Directory Service for Microsoft Active Directory allows you to
    configure trust relationships.
...
- name: AWS Directory Service API - Verify Trust
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/directories/master/_listings/aws-directory-service/actionverifytrust-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/directories/master/_listings/aws-directory-service/actionverifytrust-get-openapi.md
- name: AWS Directory Service API - Verify Trust
  x-api-slug: actionverifytrust-get
  description: AWS Directory Service for Microsoft Active Directory allows you to
    configure and verify trust relationships.
